...
<body style="margin:0;padding:0;background:#f8fafc;font-family:'Segoe UI',Roboto,Helvetica,Arial,sans-serif;">
            ...
            <td class="header-section" style="background:linear-gradient(135deg,#0d3d27 0%,#1a5e3f 60%,#22854f 100%);padding:48px 48px 40px;position:relative;overflow:hidden">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td style="vertical-align:middle;">
                          <img src="${APP_URL}/Imtihan-logo.png" alt="Imtihan" width="48" height="48" style="display:block;border-radius:14px;border:none;" />
                        </td>
                  ...
                  <td align="right" style="color:rgba(255,255,255,0.6);font-size:12px;font-weight:600;letter-spacing:1px;text-transform:uppercase;vertical-align:middle;">Education AI</td>
                </tr>
              </table>
            ...
            <td style="padding:48px 48px 0;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr><td style="padding-bottom:24px;">
                  <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      <td width="48" style="vertical-align:top;"><div style="width:36px;height:36px;background:#ecfdf5;border-radius:10px;text-align:center;line-height:36px;font-weight:800;color:#10b981;font-size:15px;border:1px solid #d1fae5;">1</div></td>
                ...
                <tr><td style="padding-bottom:24px;">
                  <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      <td width="48" style="vertical-align:top;"><div style="width:36px;height:36px;background:#ecfdf5;border-radius:10px;text-align:center;line-height:36px;font-weight:800;color:#10b981;font-size:15px;border:1px solid #d1fae5;">2</div></td>
                      <td style="padding-left:16px;vertical-align:top;">
                ...
                <tr><td>
                  <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      <td width="48" style="vertical-align:top;"><div style="width:36px;height:36px;background:#ecfdf5;border-radius:10px;text-align:center;line-height:36px;font-weight:800;color:#10b981;font-size:15px;border:1px solid #d1fae5;">3</div></td>
                      <td style="padding-left:16px;vertical-align:top;">
                  ...
                  <td width="50%" class="feature-col feature-item" style="padding-right:12px;padding-bottom:20px;vertical-align:top;">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:16px;padding:24px;">
                      <tr><td>
                        ...
                        <div style="font-weight:700;color:#1e293b;font-size:15px;margin-bottom:6px;">Version A & B</div>
                        <div style="color:#64748b;font-size:13px;line-height:1.5;">Instantly create two parallel versions of the same exam to prevent cheating.</div>
                      </td></tr>
                    </table>
                  </td>
                  <td width="50%" class="feature-col feature-item" style="padding-left:12px;padding-bottom:20px;vertical-align:top;">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:16px;padding:24px;">
                      <tr><td>
                        ...
                        <div style="font-weight:700;color:#1e293b;font-size:15px;margin-bottom:6px;">Full Barème</div>
                        <div style="color:#64748b;font-size:13px;line-height:1.5;">Every corrigé includes a detailed points breakdown for easy grading.</div>
                      </td></tr>
                    </table>
                  </td>
                </tr>
                  ...
                  <td width="50%" class="feature-col feature-item" style="padding-right:12px;vertical-align:top;">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:16px;padding:24px;">
                      <tr><td>
                        ...
                        <div style="font-weight:700;color:#1e293b;font-size:15px;margin-bottom:6px;">Exercise Bank</div>
                        <div style="color:#64748b;font-size:13px;line-height:1.5;">Save your favorite AI-generated exercises to your personal bank for reuse.</div>
                      </td></tr>
                    </table>
                  </td>
                  <td width="50%" class="feature-col feature-item" style="padding-left:12px;vertical-align:top;">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:16px;padding:24px;">
                      <tr><td>
                        ...
                        <div style="font-weight:700;color:#1e293b;font-size:15px;margin-bottom:6px;">Instant Export</div>
                        <div style="color:#64748b;font-size:13px;line-height:1.5;">Download in high-quality PDF or editable Microsoft Word format.</div>
                      </td></tr>
                    </table>
                  </td>
                </tr>
  ...
  return { subject: `Welcome to Imtihan, ${firstName}!`, html };
}

async function run() {
  console.log("Sending final test newsletter with Twemoji icons...");
