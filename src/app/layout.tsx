...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className={`${GeistSans.variable} ${GeistMono.variable} ${fraunces.variable} ${nunito.variable} ${dmSans.variable}`} suppressHydrationWarning>
      <head />
      <body>
        <Script
        ...
        {/* Privacy-friendly analytics by Plausible — real embed from the imtihan.live Plausible account */}
        <Script
          async
          src="https://plausible.io/js/pa-h5uHdOrIPNH5TEW_uzfof.js"
          strategy="afterInteractive"
        />
