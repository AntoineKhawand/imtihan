    ...
    <div className="min-h-screen bg-[var(--bg)] flex flex-col">
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 max-w-6xl mx-auto px-6 py-10">
          <ProGuard 
            featureName="AI Automated Grading" 
            featureDescription="Grade student work instantly by comparing their handwritten answers against your official marking schemes using Imtihan AI."
          >
            {/* Header */}
