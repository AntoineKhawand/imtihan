    ...
    <div className="min-h-screen bg-[var(--bg)] flex flex-col">
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 max-w-6xl mx-auto px-6 py-10">
          <ProGuard 
            featureName="AI Exam Scanner" 
            featureDescription="Transform paper questions into professional digital exercises in seconds using our advanced AI Vision technology."
          >
            {/* Header */}
