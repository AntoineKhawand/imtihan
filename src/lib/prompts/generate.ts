...
8. SIMPLICITY & PREMIUM STRUCTURE:
   ...
   - NO SOLUTION LEAKS (CRITICAL): Never include the final answers, derivatives, roots, or study summary tables (like variation tables) inside the 'statement' field. All derivations and results must stay in the 'solution' object.
   - SOLUTIONS (CORRIGÉS):
